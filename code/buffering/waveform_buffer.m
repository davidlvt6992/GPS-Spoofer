function waveform = waveform_buffer(sv_num,sv_bitstreams,LLA_pos,RX_TOW,eph_mat,...
    f_samp,f_dop,buffer_size)
%waveform_buffer creates a combined modulated waveform of several SVs using
%a buffer.
