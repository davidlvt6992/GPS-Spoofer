...
others_struct.TLM_msg = 0.5<rand(1,14); %TLM message, used by authorised user.
...
fr_arr = [frame(eph1, others_struct) frame(eph1, others_struct) frame(eph1, others_struct)];

%% creating new wf_bfile 
% we will use C/A code of a single SV and sampling of 4
create_wf_bfile([16], 4, fr_arr);