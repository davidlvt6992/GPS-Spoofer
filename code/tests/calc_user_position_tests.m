...
%compute pseudo ranges for madrid
% madrid_lla = [40.41524063127617, -3.6825268152573467 0];
% madrid_ecef = lla2ecef(madrid_lla);
% cor_delt = Xs - repmat(madrid_ecef,numSV,1)
% madrid_pr = sqrt(sum(cor_delt.^2,2))
% madrid_pr = madrid_pr-c*dsv_vec'