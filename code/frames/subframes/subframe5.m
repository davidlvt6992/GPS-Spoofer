classdef subframe5 < handle
    %subframe5 Summary of this class goes here
    ...
    properties(Constant , Access=protected)
        ...
        subframe_id = 5; %number of subframe
    end
    methods
        function obj = subframe5()
            %subframe5 Construct an instance of this class
            %   Detailed explanation goes here
